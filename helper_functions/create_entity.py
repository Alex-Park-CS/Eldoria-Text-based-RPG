...
def make_character() -> dict:
    ...
    >>> make_character()
    {'name': 'Ysera', 'maxHP': 100, 'currentHP': 100, 'gold': 0, 'level': 1, 'maxEXP': 50, 'currentEXP': 0, 'atk': 5, 'move': 'Magic Missile', 'x-position': 10, 'y-position': 20, 'orb': 0}
...
def make_pre_lv_10_field_mobs() -> list:
    ...
    [{'name': 'Mutant Boar', 'currentHP': 50, 'maxHP': 50, 'move': 'Headbutt', 'atk': 5, 'EXP': 10, 'gold': 5, 'runnable': True}, {'name': 'Legion Soldier', 'currentHP': 100, 'maxHP': 100, 'move': 'Spear Thrust', 'atk': 10, 'EXP': 25, 'gold': 20, 'runnable': True}]
    """
...
def make_post_lv_10_field_mobs() -> list:
    ...
    [{'name': 'Imp', 'currentHP': 300, 'maxHP': 300, 'atk': 20, 'EXP': 35, 'move': 'Tail Whip', 'gold': 20, 'runnable': True}, {'name': 'Legion Commander', 'currentHP': 400, 'maxHP': 400, 'move': 'Sword Slash', 'atk': 40, 'EXP': 60, 'gold': 75, 'runnable': True}]
    """
...
def make_marbas() -> dict:
    ...
    >>> make_marbas()
    {'name': 'Marbas', 'currentHP': 800, 'maxHP': 800, 'atk': 65, 'EXP': 1000, 'gold': 300, 'move': 'Tainting Hands', 'runnable': False}
    """
...
def make_andromalius() -> dict:
    ...
    >>> make_andromalius()
    {'name': 'Andromalius', 'currentHP': 1000, 'maxHP': 1000, 'atk': 55, 'EXP': 1100, 'gold': 350, 'move': "Serpent's Fang", 'runnable': False}
    """
...
def make_baal() -> dict:
    ...
    >>> make_baal()
    {'name': 'Baal', 'currentHP': 2000, 'maxHP': 2000, 'atk': 70, 'EXP': 2000, 'gold': 400, 'move': 'Thunderstorm', 'runnable': False}
    """
...
def make_shop() -> list:
    ...
    >>> make_shop()
    [{'name': 'Pill of Vitality', 'price': 50, 'added_HP': 10, 'amount': 1, 'effect': 'Increases maxHP by 10 points'}, {'name': 'Elixir of Vigor', 'price': 65, 'added_ATK': 3, 'move_upgrade': 'Arcane Barrage', 'amount': 1, 'effect': 'Increases ATK by 3 points'}, {'name': 'Forbidden White Powder', 'price': 100, 'added_EXP': 100, 'amount': 50, 'effect': 'Increases currentEXP by 100 points'}]
    """
